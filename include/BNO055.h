...
//    virtual inline const char *getName() const { return "BNO055"; }
     ...
     */
    inline float getYaw(); //{ return validateReading(mahonyAlgorithm.getYaw()); }

    /**
     * Returns pitch angle in degrees.
     */
    inline float getPitch();// { return validateReading(mahonyAlgorithm.getPitch()); }

    /**
     * Returns roll angle in degrees.
     */
    inline float getRoll();// { return validateReading(mahonyAlgorithm.getRoll()); }
     ...
     *  @param quaternion reading result
     */
    void getQuaternions(vector &quaternion);
...
//    imu_heater::ImuHeater imuHeater;
     ...
     */
    void spiWriteRegister(bno055_reg_t reg, uint8_t data);

    /**
     * Read from a given register.
     */
    void spiReadRegister(bno055_reg_t reg);
     ...
     * from that point.
     */
    void spiReadRegisters(bno055_reg_t reg, uint8_t *pData, size_t len);
