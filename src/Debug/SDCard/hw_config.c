...
static spi_t spis[] = {  // One for each SPI.
    {
        ...
        .miso_gpio = SD_CARD_MISO, // GPIO number (not pin number)
        .mosi_gpio = SD_CARD_MOSI,
        .sck_gpio = SD_CARD_SCK,
...
static sd_card_t sd_cards[] = {  // One for each SD card
    {
        ...
        .ss_gpio = SD_CARD_SS,    // The SPI slave select GPIO for this SD card
        .use_card_detect = true,
        .card_detect_gpio = SD_CARD_SS,   // Card detect
